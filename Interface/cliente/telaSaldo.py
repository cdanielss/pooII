...
"background-color: rgb(93, 93, 93);")
        ...
        self.botao_sair.setGeometry(QtCore.QRect(170, 410, 131, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.campo_saldo = QtWidgets.QLineEdit(self.frame_4)
        self.campo_saldo.setGeometry(QtCore.QRect(150, 230, 161, 31))
        self.campo_saldo.setStyleSheet("background-color: rgb(91, 91, 91);")
        self.campo_saldo.setObjectName("campo_saldo")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600;\">Saldo</span></p></body></html>"))
        self.botao_sair.setText(_translate("MainWindow", "Sair"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:11pt;\">Saldo total</span></p></body></html>"))
